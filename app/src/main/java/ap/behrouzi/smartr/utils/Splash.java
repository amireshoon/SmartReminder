...
public class Splash {
    ...
    private void initViews() {
        ...
        mSplashImageBackground.setBackgroundColor(ContextCompat.getColor(mContext, R.color.white));
        mSplashBackgroundColor = ContextCompat.getColor(mContext, R.color.b);
    ...
    private void processMask() {
         ...
         * */
        float left = mScreenWidth / 40f - mask.getWidth() / 40f;
        float top = mScreenHeight / 40f - mask.getHeight() / 40f;
